...
import { isVendorRankingQuestion } from "../../routing/detectSubject.ts"
import { vendorIncludedForTrade } from "../../tools/vendors/vendorBestLookup.ts"
import { aggregateTradeJobs } from "../../tools/vendors/vendorTradeJobHistory.ts"
