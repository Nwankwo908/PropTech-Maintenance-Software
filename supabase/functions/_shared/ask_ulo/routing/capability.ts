...
import { isDraftCommunicationQuestion } from "../tools/maintenance/draftCommunication.ts"
...
export function detectAskUloCapability(
  ...
  if (isVendorVerificationStatusQuestion(q) && subj === "vendor") {
    return {
      capability: "search",
      confidence: "high",
      hints: { metric: "vendor_verification" },
    }
  }
