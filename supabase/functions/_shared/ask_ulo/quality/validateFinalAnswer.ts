...
import type { LegalJurisdictionResolution } from "./checkJurisdiction.ts"
import type { LegalSourceTier } from "./legalSourceTrust.ts"
import { evaluateTaskCompletionQc } from "../tools/maintenance/taskCompletion.ts"
import { evaluateEntityInvestigationQc } from "../tools/maintenance/entityInvestigation.ts"
import { evaluateInvestigationDefinitionQc } from "../tools/_shared/investigationDefinition.ts"
import { evaluateResponseSufficiencyQc } from "./checkCompleteness.ts"
import { evaluateMissingInfoCommunicationQc } from "../guards/refusalBuilder.ts"
import {
...
import { isRecurringRepairsQuestion, looksLikePropertyInsightsHeadlineDump } from "../tools/maintenance/recurringRepairsLookup.ts"
import { evaluateSubjectMatchQc } from "../routing/detectSubject.ts"
import { evaluateMetricMatchQc } from "../tools/_shared/questionMetricContext.ts"
