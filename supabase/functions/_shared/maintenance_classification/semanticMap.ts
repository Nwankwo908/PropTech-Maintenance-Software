...
export const SEMANTIC_PHRASE_LIBRARY: PhraseExample[] = [
  ...
  { phrase: "water pouring through the ceiling after rain", trade: "roofing", issueType: "roofing" },
  { phrase: "ceiling leak after rain", trade: "roofing", issueType: "roofing" },
  { phrase: "the radiator is cold", trade: "plumbing", issueType: "hvac" },
  { phrase: "bugs underneath my dishwasher", trade: "pest_control", issueType: "pest" },
  { phrase: "mice inside the wall", trade: "pest_control", issueType: "pest" },
