...
const ONBOARDING_PROPERTY_TYPE_OPTIONS: { value: string; label: string }[] = [
...
/** Map extracted or legacy property type strings to a canonical onboarding value. */
export function normalizeExtractedPropertyType(value: unknown): string {
...
export function inferPropertyTypeFromUnitCount(unitCount: number): string {
