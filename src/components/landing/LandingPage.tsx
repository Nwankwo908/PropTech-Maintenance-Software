...
function HeroHeadlineAndCopy() {
  ...
  useEffect(() => {
    const mq = window.matchMedia(
      '(max-width: 1019px) and (min-height: 1400px) and (max-height: 1500px)',
    )
  ...
  return (
    <>
      ...
      <p
        className="mt-4 box-border max-w-full border-l-[3px] border-[#187960] pl-4 text-base text-[#4b5563] sm:mt-6 sm:pl-5 sm:text-lg [@media(max-width:1019px)_and_(min-height:1400px)_and_(max-height:1500px)]:!w-full"
        style={{
          lineHeight: 1.15,
