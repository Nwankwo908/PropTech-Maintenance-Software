...
export function ChangeAssignedVendorModal({
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/40 p-4">
      <div
        role="presentation"
        className="sa-scrim absolute inset-0"
        aria-hidden
        onClick={() => {
          if (!saving) onClose()
        }}
      ...
      >
        <div className="flex h-[59px] shrink-0 items-center justify-between bg-[#b58500] px-6">
          ...
          <button
            ...
            disabled={saving}
            className="sa-press shrink-0 rounded-lg px-2 py-1 text-[14px] font-medium leading-5 text-white/90 outline-none hover:bg-white/15 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#b58500] disabled:pointer-events-none disabled:opacity-50"
          >
            Close
          </button>
        </div>
        ...
        <div className="flex flex-col gap-4 px-6 pb-6 pt-6">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-[12px] leading-4 text-neutral">
              ...
              specialties listed under Vendors.
            </p>
          ...
          <div className="flex w-full min-w-0 gap-3 pt-1">
            <button
              ...
              className="sa-press inline-flex h-9 min-w-0 flex-1 items-center justify-center gap-2 rounded-lg bg-[#b58500] px-4 text-[14px] font-medium leading-5 tracking-[-0.1504px] text-white outline-none hover:bg-[#9a7310] focus-visible:ring-2 focus-visible:ring-[#b58500] focus-visible:ring-offset-2 focus-visible:ring-offset-white disabled:pointer-events-none disabled:opacity-60"
            >
            ...
            <button
              ...
              onClick={onClose}
              disabled={saving}
              className="sa-press inline-flex h-9 min-w-0 flex-1 items-center justify-center rounded-lg border border-black/10 bg-white px-4 text-[14px] font-medium leading-5 tracking-[-0.1504px] text-extended-3 outline-none hover:bg-secondary focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-60"
            >
              Cancel
            </button>
          </div>
