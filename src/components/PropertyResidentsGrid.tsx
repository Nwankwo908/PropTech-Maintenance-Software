  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <span className="inline-flex size-10 shrink-0 items-center justify-center rounded-full bg-[#f3f4f6] text-[13px] font-semibold text-[#6a7282] transition-colors duration-200">
          {resident.initials}
        </span>
