  ...
  return createPortal(
    ...
    >
      ...
      <div
        ...
        className={
          fromEnd
            ? 'sa-rail relative z-10 flex h-full max-h-dvh min-h-0 w-full max-w-[min(100vw,420px)] flex-col overflow-hidden rounded-l-[16px] border-y border-l border-[#e5e7eb] bg-white pb-[env(safe-area-inset-bottom,0px)] shadow-[-8px_0_24px_rgba(0,0,0,0.12)]'
            : 'sa-sheet relative z-10 flex max-h-[min(92dvh,840px)] min-h-0 w-full flex-col overflow-hidden rounded-t-[16px] border border-[#e5e7eb] bg-white pb-[env(safe-area-inset-bottom,0px)] shadow-[0px_-8px_24px_rgba(0,0,0,0.12)]'
        }
      >
        {fromEnd ? null : (
